    ...
    return (
        <div className={"flex flex-col p-4 justify-center h-dvh"}>
            <form className={"flex flex-col gap-2 p-4 border-black border-2 rounded-sm"}>
                <h1 className={"text-6xl text-center p-4 mb-4"}>Sign Up</h1>
                <label>Email</label>
                <input name={"email"} placeholder={"example@example.com"} className={"border-black border-2 p-2 rounded-sm"}/>
                <label>Username</label>
                <input name={"username"} placeholder={"example"} className={"border-black border-2 p-2 rounded-sm"}/>
                <label>Password</label>
                <input name={"password"} placeholder={"abc123"} className={"border-black border-2 p-2 rounded-sm"}/>
                <label>Confirm Password</label>
                <input name={"confirmPassword"} placeholder={"abc123"} className={"border-black border-2 p-2 rounded-sm"}/>
                <label>Birthday</label>
                <input name={"birthday"} placeholder={"MM-DD-YYYY"} className={"border-black border-2 p-2 rounded-sm"}/>
